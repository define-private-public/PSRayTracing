...
#include "Scenes/Book1.hpp"
#include "Scenes/Book2.hpp"
#include "Scenes/Book3.hpp"
...
const std::unordered_map<std::string, std::function<SceneCameraPair(rreal)>> AvailableScenes {
    ...
    {Fun_WaveOfSpheres, [](const rreal aspect_ratio) {
        SceneCameraPair scp;
        scp.scene = Scenes::Fun::wave_of_spheres(aspect_ratio);
        return scp;
    }},
};
